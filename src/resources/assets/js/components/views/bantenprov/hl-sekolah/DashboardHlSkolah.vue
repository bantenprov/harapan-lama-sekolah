          ...
          <div class="card-body">
            <div class="media">
              <div class="media-body text-truncate">
                <div class="card-body">
                  <hl-sekolah-bar-03></hl-sekolah-bar-03>
                </div><!-- /.card-body -->
              </div>
            </div>
          </div><!-- /.card-body -->
        ...
        <div class="card card-media text-white bg-success">
          <div class="card-body">
            <div class="media">
              <div class="media-body text-truncate">
                <div class="card-body">
                  <hl-sekolah-pie-03></hl-sekolah-pie-03>
                </div><!-- /.card-body -->
              </div>
            </div>
          </div><!-- /.card-body -->
    ...
    <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              Harapan Lama Sekolah Berdasarkan Wilayah
            </div>
            <div class="card-body">
              <hl-sekolah-bar-01></hl-sekolah-bar-01>
            </div><!-- /.card-body -->
          </div><!-- /.card -->
        ...
        <div class="col-md-4">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              <hl-sekolah-pie-01></hl-sekolah-pie-01>
            </div><!-- /.card-body -->
          </div><!-- /.card -->
      ...
      <div class="col-md-8">
        ...
        <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-bar-chart" aria-hidden="true"></i>
            Harapan Lama Sekolah Berdasarkan Tahun
          </div>
          <div class="card-body">
            <hl-sekolah-bar-02></hl-sekolah-bar-02>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      ...
      <div class="col-md-4">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <hl-sekolah-pie-02></hl-sekolah-pie-02>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
